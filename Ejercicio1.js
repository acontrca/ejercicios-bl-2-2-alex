...
const texto =
 ...
 textArray.forEach(palabra => {
  const largoPalabra = palabra.length;
  if(textoAgrupado[largoPalabra]){
    textoAgrupado[largoPalabra].push(palabra);
  } else {
    textoAgrupado[largoPalabra] = [palabra];
  }
 })

 console.log(textArray);
 console.log(textoAgrupado);